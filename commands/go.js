...
exports.run = async (client, interaction) => {
  ...
  if (tempOutput === null) {
    await interaction.reply('Wovor der Wunderausbau gestartet werden kann, muss ein Infopanel mit `/wfi [WunderSynonym] [WunderStufe] [IngameName]` für diesen angelegt werden.')
    return;
  }
